        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <img src="./public/upload/images/<?= (isset($data['product']['AnhChinh'])) ? $data['product']['AnhChinh'] : ''?>" alt="" id="img-sp">
                </div>
                ...
                <div class="more-info">
                    Liên hệ trực tiếp hotline: <strong style="width:auto;">1900 2268</strong> để nhận được sự tư vấn
                    tốt nhất
...
<div class=" binh-luan" style="margin-top: 30px;">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="position: relative; display: flex;">
        ...
        <form action="./sanpham/comment/<?=$data["product"]["Slug"]?>" method="post" accept-charset="utf-8" onsubmit="return CheckSession();" class="form-control d-flex align-items-center justify-content-between">
            <label for="comment" id="lb"><img src="./public/client/images/user/user_02.jpg" id="user"></label>
...
<div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
    ...
    <section class="camket-right border">
        ...
        <ul class="list-unstyled p-3">
            <li><i class="fa fa-thumbs-up" aria-hidden="true"></i>Hoa quả tươi sạch</li>
            <li><i class="fa fa-thumbs-up" aria-hidden="true"></i>Không chất bảo quản</li>
            <li><i class="fa fa-thumbs-up" aria-hidden="true"></i>Dịch vụ chuyên nghiệp</li>
            <li><i class="fa fa-thumbs-up" aria-hidden="true"></i>Không thuốc biến đổi gien</li>
            <li><i class="fa fa-thumbs-up" aria-hidden="true"></i>Không hàng Trung Quốc</li>
