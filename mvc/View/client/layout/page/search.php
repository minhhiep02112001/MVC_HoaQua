                    ...
                    <div class="product">
                        <div class="img">
                            ...
                            <div class="information ">
                                ...
                                <div class="view">
                                    <a href="./sanpham/get/<?=$key["Slug"]?>" tabindex="0"><i class="fa fa-eye" style="font-size: 12px;"></i> Xem nhanh </a>
                                    <a href="javascript:;" onclick="SweetAlterDetailProduct('<?=$key["MaSP"]?>')" class="listproduct" tabindex="0"><i class="fa fa-shopping-cart"></i>Giỏ Hàng </a>
                                </div>
                            </div>
                        </div>
                        <div class="info">
