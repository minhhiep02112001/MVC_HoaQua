...
<section class="header">
  ...
  <div class="container column-one d-flex justify-content-around align-items-center">
    ...
    <div class="logo">
      <img src="./public/upload/images/logo-fruit-drank-new.png" style="width:auto; height:100%;" alt="">
    </div>
    <div class="search">
      <form action="./search" method="get" accept-charset="utf-8">
        <div class="input-group"> <input type="text" class="form-control input-text" name="val" id="val" placeholder="Search products...." aria-label="Recipient's username" aria-describedby="basic-addon2">
    ...
    <ul class="container menu-header ">
      ...
      <li class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
            <button class="dropdown-item" type="button">Cài Đặt</button>
